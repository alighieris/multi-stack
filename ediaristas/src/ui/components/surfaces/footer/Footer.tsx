    ...
    <FooterStyled>
      <FooterContainer>
        <Box sx={{ maxWidth: "400px" }}>
          ...
          Isso /\ é o mesmo disso \/, porém usando o parâmetro 'sx', que
          abrevia o nome da configuração e busca o padrão do espaçamento
          direto do tema do projeto*/}
        ...
        <div>
          ...
          <AppList>
            <li>
              <a href={"/"} target="_blank" rel={"noopener_noreferrer"}>
